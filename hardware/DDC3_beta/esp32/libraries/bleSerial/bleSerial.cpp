...
Adafruit_NeoPixel debugPixels(1, 21, NEO_GRB + NEO_KHZ800); // ESP32-C3 LED
...
class BLESerialServerCallbacks: public BLEServerCallbacks {
    ...
    void onDisconnect(BLEServer* pServer) {
		debugPixels.setPixelColor(0, debugPixels.Color(0, 0, 0)); // Testing for bleSerial timeout issue 
		debugPixels.show();   // Send the updated pixel colors to the hardware.
...
size_t BLESerial::write(uint8_t *buffer,size_t size) 
{
    // write a buffer
