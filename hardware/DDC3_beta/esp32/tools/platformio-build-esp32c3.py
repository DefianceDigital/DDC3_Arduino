...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_DIR, "tools", "sdk", "esp32c3", "include", "esp-sr", "esp-tts", "esp_tts_chinese", "include"),
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.4.5-300-ga49e0180ee\\"'),
        "ESP_PLATFORM",
